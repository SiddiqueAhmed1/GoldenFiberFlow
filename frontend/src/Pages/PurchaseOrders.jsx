...
const EmptyState = ({ search }) => (
  <div className="flex flex-col items-center justify-center py-20 gap-3 text-neutral-400 dark:text-neutral-500">
    ...
    <p className="text-sm">
      {!search && "Click 'Create Order' to get started"}
    </p>
  </div>
);
                  ...
                  <tbody>
                    {filtered.map((o) => (
                      ...
                      >
                        ...
                        <td className="px-5 py-3.5 text-neutral-600 dark:text-neutral-300 text-center">
                          {o.items?.length}
                        </td>
                        ...
                        <td className="px-5 py-3.5">
                          <span
                            className={`px-2.5 py-1 rounded-full text-xs font-semibold whitespace-nowrap ${statusStyle(o.status)}`}
                          >
                            {o.status}
                          </span>
                        </td>
