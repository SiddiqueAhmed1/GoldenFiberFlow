            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-neutral-50 dark:bg-neutral-700/30 text-neutral-500 dark:text-neutral-400 text-left">
                  <th className="px-5 py-3 text-black uppercase">Sender</th>
                  <th className="px-5 py-3 text-black uppercase">Receiver</th>
                  <th className="px-5 py-3 text-black uppercase">Date</th>
                  <th className="px-5 py-3 text-black uppercase">Status</th>
                </tr>
              </thead>
              <tbody>
